...
//? Carbon::createFromFormat('m/d/Y g:i:s A', $request->datetime)->format('Y-m-d H:i:s') : null;
        ...
        if($status=='VALID'){
            ...
            $reply_sms_content = "Dear Customer, thank you for your participation. Keep the empty pouch with you until results are announced. All the best. Thank you for using Sun Premium Sunflower Oil. Anagha Refineries.";
